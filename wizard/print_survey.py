...
class surveys_print(osv.TransientModel):
    ...
    def action_print(self, cr, uid, ids, context=None):
        ...
        survey_ids = self.pool.get('survey.info').search(cr,uid,[('status','=','approved'),('customer_surv','=',data['customer_id'][0]),('month','=',data['month'])])
    ...
    #     survey_ids = self.pool.get('survey.info').write(cr,uid,context['active_id'],vals)
    #     return {
